...
ActiveRecord::Schema.define(version: 2021_07_26_043103) do
  ...
  create_table "product_tags_relations", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "product_id"
    t.bigint "tag_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["product_id"], name: "index_product_tags_relations_on_product_id"
    t.index ["tag_id"], name: "index_product_tags_relations_on_tag_id"
  end
  ...
  add_foreign_key "product_tags_relations", "products"
  add_foreign_key "product_tags_relations", "tags"
